...
La valeur enregistrée aux coordonnées [800, 500] vaut `r sst[800, 500]`

Elle correspond normalement à la température pour la longitude `r lon[800]` et la latitude `r lat[500]`
...
head(df_sst)
df_sst |> dplyr::filter(lon == lon_800 & lat == lat_500)

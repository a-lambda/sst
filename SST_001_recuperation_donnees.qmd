...
```{r}
#| label: install_and_load_libraries
#| message: false
#| code-fold: true
...
## Comptabilisation des fichiers de données théoriquement disponibles
...
### Suppression des fichiers inutiles présents dans `DATA/RAW`
...
### Téléchargement des données SST (citère data_loaded == FALSE)

...
tib_sst$data_file <- c(url_valid_variable_parts[[2]], url_preliminary_variable_parts[[2]])
...
# Vérification de l'existence des fichiers nc dans le dossier DATA

nc_files <- tib_sst$data_file
...
# data_loaded renseigne sur la présence du fichier en local
# 

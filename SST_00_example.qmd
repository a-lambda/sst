...
get_polygone_sf <- function(lon = 0) {
  
  seq(-90, 89.75, by = 0.25) |>
  map(\(x) polygone_geo(lon = lon, lat = x, n = 0.25)) |> 
...
polygone_sf <- get_polygone_sf()
area_weights <- as.numeric(st_area(polygone_sf) / max(st_area(polygone_sf)))
